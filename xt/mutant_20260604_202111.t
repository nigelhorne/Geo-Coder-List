...
# Source:  $self->_warn(ref($geocoder), " '$location': $@");
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # upgrade the geocoder field and populate the canonical geometry
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip >= to >
#   Numeric boundary flip >= to <
...
# Source:  # Populate canonical geometry structure from the GLP's own fields
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  $long  = $l->{'results'}[0]->{'geometry'}->{'location'}->{'lng'};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  $long  = $l->{features}[0]->{center}[0];
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  print Data::Dumper->new([\@rc])->Dump();
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (4 variants — one test should kill all):
#   Numeric boundary flip >= to >
#   Numeric boundary flip >= to <
...
# Source:  my $version = eval { $geocoder->VERSION() } // '';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  my @call_details = caller(0);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  eval { @locs = $geocoder->reverse_geocode(%{$params}) };
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  eval { @locs = $geocoder->reverse_geocode(%no_latlng) };
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # OSM returns the full address in display_name
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip >= to >
#   Numeric boundary flip >= to <
...
# Source:  # Geo::Coder::CA: build the address from individual fields
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  my $rc = $self->_cache($latlng)
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  $rc = eval { $geocoder->reverse_geocode(%no_latlng) };
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  $name .= ($name ? ' ' : '') . $usa->{'usstaddress'} if $usa->{'usstaddress'};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  next unless ref($item) eq 'HASH';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # is always true here; the false arm never executes.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition unless to if
TODO: {
...
# Source:  $rc->{'lon'} //= $rc->{geometry}{location}{lng};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: BOOL_NEGATE_1346_2 (MEDIUM) line 1346 in _debug() ---
# Source:  sub _debug {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_1346_2 line 1346 in _debug()';
    # NOTE: new() called with no arguments as a starting point.
    # If Geo::Coder::List requires constructor arguments, add them here.
    my $obj = new_ok('Geo::Coder::List');
    # TODO: exercise line 1346 in _debug() to detect the mutant
...
# --- LOW HINT: RETURN_UNDEF_1346_2 line 1346 in _debug() ---
# Source:  sub _debug {
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
